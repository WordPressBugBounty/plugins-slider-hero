            ...
            <div class="support-btn-main justify-content-center">
                <div class="col text-center">
                    ...
                    <div class="support-btn">
                        ...
                        <a style="width:282px" class="premium-support" href="<?php echo esc_url('https://www.quantumcloud.com/resources/kb-sections/slider-hero/'); ?>" target="_blank"><?php esc_html_e('Online KnowledgeBase', 'qc-clr'); ?></a>
                    </div>
                </div>

...
add_action( 'wp_ajax_qcld_sliderhero_recommend_support_function_first_ajax', 'qcld_sliderhero_recommend_support_function_first_ajax' );

if( !function_exists('qcld_sliderhero_recommend_support_function_first_ajax') ){

    function qcld_sliderhero_recommend_support_function_first_ajax(){
            ...
            $argus = [
                ...
                [
                    ...
                    'live_preview'   => 'https://turbopowers.com/pricing/',
                    'update_to_pro'  => 'https://turbopowers.com/kbx/'
                ], 
                [
                                        ...
                                        if ( $status['url'] ) {
                                            if ( $compatible_php && $compatible_wp ) {
                                                $action_links[] = sprintf(
                                                    ...
                                                    esc_attr( $name ),
                                                    esc_html( 'Install Now', 'slider-hero' )
                                                );
                                            } else {
                                                $action_links[] = sprintf(
...
add_action( 'wp_ajax_qcld_sliderhero_recommend_support_function_second_ajax', 'qcld_sliderhero_recommend_support_function_second_ajax' );

if( !function_exists('qcld_sliderhero_recommend_support_function_second_ajax') ){

    function qcld_sliderhero_recommend_support_function_second_ajax(){
...
add_action( 'wp_ajax_qcld_sliderhero_recommend_support_function_third_ajax', 'qcld_sliderhero_recommend_support_function_third_ajax' );

if( !function_exists('qcld_sliderhero_recommend_support_function_third_ajax') ){

    function qcld_sliderhero_recommend_support_function_third_ajax(){
...
add_action( 'wp_ajax_qcld_sliderhero_recommend_support_function_four_ajax', 'qcld_sliderhero_recommend_support_function_four_ajax' );

if( !function_exists('qcld_sliderhero_recommend_support_function_four_ajax') ){

    function qcld_sliderhero_recommend_support_function_four_ajax(){

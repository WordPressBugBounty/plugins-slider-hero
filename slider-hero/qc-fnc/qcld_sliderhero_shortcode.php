...
?>
			...
			<?php if(isset($btn->button_font_size) && $btn->button_font_size!=''):
			?>
			...
			<?php if(isset($btn->button_letter_spacing) && $btn->button_letter_spacing!=''):
			?>
				letter-spacing: <?php echo esc_attr( $btn->button_letter_spacing ); ?> !important;
			<?php endif; ?>
			
			<?php if(isset($btn->button_font_weight) && $btn->button_font_weight!=''):
			?>
			...
			<?php endif; ?>
			<?php }elseif($type=='2' && $btn2->hero_button_shortcode=='1'){ ?>
			<style type="text/css">
			.hero_btn_cls_one2{
			...
			<?php endif; ?>
				...
				text-shadow: none;
			<?php if(isset($btn2->button_font_size) && $btn2->button_font_size!=''):
			?>
			...
			<?php if(isset($btn2->button_letter_spacing) && $btn2->button_letter_spacing!=''):
			?>
				letter-spacing: <?php echo esc_attr( $btn2->button_letter_spacing ); ?> !important;
			<?php endif; ?>
			
			<?php if(isset($btn2->button_font_weight) && $btn2->button_font_weight!=''):
			?>

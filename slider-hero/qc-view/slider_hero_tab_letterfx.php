...
<div class="othersetting">
	...
	<div class="params titleffect customitemstyle lfxtab lfxtitlein">
		...
		<input type="hidden" id="lfxtitlein" name="params[lfxtitlein]" value="<?php echo esc_attr(isset($params->lfxtitlein) && $params->lfxtitlein!=''?$params->lfxtitlein:''); ?>" />
	</div>
	...
	<div class="params titleffect customitemstyle lfxtab lfxtitleout">
		...
		<input type="hidden" id="lfxtitleout" name="params[lfxtitleout]" value="<?php echo esc_attr(isset($params->lfxtitleout) && $params->lfxtitleout!=''?$params->lfxtitleout:''); ?>" />
	</div>
	...
	<div class="params titleffect customitemstyle lfxtab lfxdesin">
		...
		<label class="customlevel" for="qcslide-effect-slideffect"><?php esc_html_e('Description In Effect', 'slider-hero'); ?>:</label>
		...
		<input type="hidden" id="lfxdesin" name="params[lfxdesin]" value="<?php echo esc_attr(isset($params->lfxdesin) && $params->lfxdesin!=''?$params->lfxdesin:''); ?>" />
	</div>
	...
	<div class="params titleffect customitemstyle lfxtab lfxdesout">
		...
		<label class="customlevel" for="qcslide-effect-slideffect"><?php esc_html_e('Description Out Effect', 'slider-hero'); ?>:</label>
		...
		<input type="hidden" id="lfxdesout" name="params[lfxdesout]" value="<?php echo esc_attr(isset($params->lfxdesout) && $params->lfxdesout!=''?$params->lfxdesout:''); ?>" />
	</div>

...
if(isset($params->video)&& $params->video=='custom'):  ?>
<?php
...
if(isset($params->controllerposition) && $params->controllerposition=='topleft'): ?>
left:0px;
top:0px;
<?php

elseif(isset($params->controllerposition) && $params->controllerposition=='topright'): ?>
right:0px;
top:0px;
<?php

elseif(isset($params->controllerposition) && $params->controllerposition=='bottomleft'): ?>
left:0px;
bottom:0px;
<?php

elseif(isset($params->controllerposition) && $params->controllerposition=='bottomright'): ?>
right:0px;
bottom:0px;
<?php
...
if(isset($params->audiocontrol) && $params->audiocontrol==1){ ?>
	<div class="hero_audio_control">
	
	<?php

if(isset($params->audioautoplay) && $params->audioautoplay==1){ ?>
		<span id="hero_control_pause"><img src="<?php echo esc_url(QCLD_SLIDERHERO_IMAGES).'/volume.gif'; ?>" /></span>
		<span id="hero_control_play" style="display:none;"><img src="<?php echo esc_url(QCLD_SLIDERHERO_IMAGES).'/volume.png'; ?>" /></span>
	<?php

}else{ ?>
		<span id="hero_control_pause" style="display:none;"><img src="<?php echo esc_url(QCLD_SLIDERHERO_IMAGES).'/volume.gif'; ?>" /></span>
		<span id="hero_control_play" ><img src="<?php echo esc_url(QCLD_SLIDERHERO_IMAGES).'/volume.png'; ?>" /></span>
	<?php
...
if(isset($params->controllerposition) && $params->controllerposition=='bottomright'): ?>
...
if(isset($params->controllerposition) && $params->controllerposition=='bottomleft'): ?>
	if(window.innerHeight>1499){
		jQuery('.hero_audio_control').css({
			'left':'2%',
			'bottom':'12%'
...
if(isset($params->audiorepeat) && $params->audiorepeat==1 and isset($params->audiorepeatcount) and $params->audiorepeatcount!=''): ?>
		
		var times = <?php

echo esc_attr( $params->audiorepeatcount ); ?>;
...
if(isset($params->audiorepeat) && $params->audiorepeat==1){ ?>
		audio.loop = true;
		<?php

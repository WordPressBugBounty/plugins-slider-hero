...
if($_slider[0]->type!='intro'): ?>	
	<div class="params deseffect customitemstyle">
		<label class="customlevel" for="qcslide-effect-slideffect"><?php esc_html_e('Button In Effect', 'slider-hero'); ?>:</label>
	...
	<div class="params deseffect customitemstyle">
		<label class="customlevel" for="qcslide-effect-slideffect"><?php esc_html_e('Button Out Effect', 'slider-hero'); ?>:</label>
...
if($_slider[0]->type=='intro'): ?>
	<div class="params deseffect customitemstyle">
		<label class="customlevel" for="qcslide-effect-slideffect"><?php esc_html_e('Intro Background Effect', 'slider-hero'); ?>:</label>

...
<div class="qcld-hero-gradient-modal" id="qcld-hero-gradient-modal" style="display:none">
  ...
  <h1 style="font-size: 16px;" class="qcld-hero-gradient-modal-title"><?php esc_html_e('Gradients', 'slider-hero'); ?></h1>
  <p style="margin-top: 18px;"><?php esc_html_e('Please Select A gradient by clicking on it.', 'slider-hero'); ?></p>
